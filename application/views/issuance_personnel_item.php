				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<div class="navbar-left">
						<ul class="navbar-breadcrumbs list-inline">
							...
							<li>/</li>
							<li><a href="adjust-equipment-issuance-step-2.html">Adjust Issuance</a></li>
							<li>/</li>
					...
					<div class="row">
						...
						foreach ($getPersonnelIssuanceISNO as $row){ $isno = $row->isno;$personnel_name = $row->personnel_name; }?>
							<div class="row-header">
								<h1 class="page-title">Issue Equipment to <?= $personnel_name; ?></h1>
							</div>	
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading text-right">
									<button type="button" data-toggle="modal" data-target="#addEquipmentModal" class="btn btn-primary"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> Equipment</button>
								</div>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th>Particulars</th>
												<th>In Stock <small>(Available)</small></th>
												<th>Issued</th>
												<th>Received</th>
										...
										if ($row->issued == 0){ ?> 
											...
											<?php } ?>
												...
												<td class="col-md-1">
												<?php if ($row->issued == 0){ ?>
													<button type="button" data-toggle="modal" data-target="#issueAddModal<?= $row->iino; ?>" class="btn btn-default btn-xs"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> <span class="sr-only">Issue</span></button>
												<?php }else{ ?> 
													<button type="button" data-toggle="modal" data-target="#issueEditModal<?= $row->iino; ?>" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i> <span class="sr-only">Issue</span></button>
												<?php }?>
												</td>
											</tr>
										<?php } ?>
	...
	<div class="modal fade" id="issueAddModal<?= $row->iino; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalLabel">Add - <?= $row->particulars; ?></h4>
				</div>
				<div class="modal-body">
					<?php echo form_open("ppeims/UpdateItemIssued"); ?>
	...
	<div class="modal fade" id="removeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button><?php 
											$data = [
