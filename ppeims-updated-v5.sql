...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2017 at 11:06 PM
...
INSERT INTO `delegates` (`id`, `pname`, `pby`, `nname`, `nby`) VALUES
(1, 'RS LEMENCE', 'Safety Officer, Agus 6/7, HEPC', 'MB JABAY', 'OIC PTS, Agus 6/7, HEPC');
...
(27, 2, 'Chemical Glove', '5 pcs', ''),
(28, 2, 'Chemical Suit (Disposable)', '13 pcs', ''),
(29, 2, 'Dust Mask (N95)', '20 pcs', ''),
(30, 2, 'Ear Plug', '40 pcs', ''),
(31, 2, 'Face Shield', '0 pcs', ''),
(32, 2, 'Fire Escape Mask', '0 pcs', ''),
(33, 2, 'First Aid Kit (Red)', '0 set', ''),
(34, 2, 'First Aid Kit (White)', '0 set', ''),
(35, 2, 'Gas Filter', '0 pcs', ''),
(36, 2, 'Gas Mask (Half Face)', '0 pcs', ''),
(37, 2, 'Hand Glove (Knitted)', '0 pcs', ''),
(38, 2, 'Hard Hat (Blue)', '0 pcs', ''),
(39, 2, 'Hard Hat (Yellow)', '0 pcs', ''),
(40, 2, 'High Voltage Glove', '0 pcs', ''),
(41, 2, 'Protective Eyewear', '0 pcs', ''),
(42, 2, 'Rain Suit', '0 set', ''),
(43, 2, 'Reflectorized Vest', '0 pcs', ''),
(44, 2, 'Respirator (Cartridge)', '0 pcs', ''),
(45, 2, 'Respirator (Full Face)', '0 pcs', ''),
(46, 2, 'Rubber Boots', '0 pcs', ''),
(47, 2, 'Safety Harness w/ Lanyard', '0 pcs', ''),
(48, 2, 'Safety Shoes', '0 pcs', ''),
(49, 2, 'SCBA', '0 set', ''),
(50, 2, 'Welder Hand Glove', '0 pcs', ''),
(51, 2, 'Welding Mask', '0 pcs', ''),
(52, 2, 'Working Clothes', '0 pcs', '');
...
(1, 'Chemical Glove', 10, 1, 'pcs', '2015-01-20', 1, 10),
(2, 'Chemical Glove', 9, 1, 'pcs', '2015-01-19', 2, 10),
(3, 'Chemical Glove', 8, 1, 'pcs', '2015-01-19', 3, 10),
(4, 'Chemical Suit (Disposable)', 15, 1, 'pcs', '2015-01-25', 4, 20),
(5, 'Chemical Suit (Disposable)', 14, 1, 'pcs', '2015-01-24', 5, 20),
(6, 'Chemical Glove', 7, 1, 'pcs', '2015-01-25', 4, 10),
(7, 'Chemical Glove', 6, 1, 'pcs', '2015-01-30', 6, 10),
...
--
ALTER TABLE `inventory_report`
  MODIFY `irid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `inventory_report_details`
--
ALTER TABLE `inventory_report_details`
  MODIFY `irdid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
--
