...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2017 at 08:25 AM
...
(21, 'Chemical Suit (Disposable)', '', 45, 5, 0, 'pcs', ''),
(22, 'Gas Filter', '', 0, 0, 0, 'pcs', ''),
(23, 'First Aid Kit (White)', '', 0, 0, 0, 'set', ''),
(24, 'First Aid Kit (Red)', '', 0, 0, 0, 'set', ''),
(25, 'Gas Mask (Half Face)', '', 0, 0, 0, 'pcs', ''),
(26, 'Fire Escape Mask', '', 0, 2, 0, 'pcs', ''),
(27, 'SCBA', '', 30, 10, 0, 'set', '');
...
--
ALTER TABLE `issuance`
  MODIFY `isno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `item_issued`
--
ALTER TABLE `item_issued`
  MODIFY `iino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `personnel_issued`
  MODIFY `pino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `updated_transaction`
--
ALTER TABLE `updated_transaction`
  MODIFY `Tr_No` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `updated_transaction_details`
--
ALTER TABLE `updated_transaction_details`
  MODIFY `Tr_D_No` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
