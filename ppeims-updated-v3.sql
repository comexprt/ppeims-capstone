...
(4, 'Alfeche-Wilfredo-Aligno', 'Maintenance-Agus 6 HEP', 1, 2),
...
--
ALTER TABLE `inventory_report_details`
  MODIFY `irdid` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `issuance`
--
ALTER TABLE `issuance`
  MODIFY `isno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `item_issued`
--
ALTER TABLE `item_issued`
  MODIFY `iino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `personnel_issued`
  MODIFY `pino` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
